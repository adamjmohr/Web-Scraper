...
public class Scraper {
     ...
     * instructions
     */
    private static final String CLIENT_ID = "8YK_LGAZ8qq2Uw";
    private static final String CLIENT_SECRET = "L8upnISPnR1DNtIV1tmIUtJ6zNw";
    private static final String REDDIT_USER = "Iplaymobas";

    /**
     * replace yourname with your name in the text below, no spaces and
     * lowercase
     */
    private static final String APPID = "com.algonquin.cst8288.mohrad";
