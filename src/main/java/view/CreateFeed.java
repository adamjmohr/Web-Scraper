...
public class CreateFeed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.printf("<input type=\"number\" name=\"%s\" value=\"\"><br>",FeedLogic.HOST_ID);
            out.println("<br>");
     ...
     * will create a Feed this method simple delivers the html code. 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fLogic.getFeedWithPath(path) == null) {
            try {
                ...
                Host host = new Host(Integer.parseInt(request.getParameter(FeedLogic.HOST_ID)));
                feed.setHostid(host);
                fLogic.add(feed);
